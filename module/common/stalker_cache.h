...
#define COMMON_KALLOC                                   (0x100)
#define COMMON_KFREE                                    (0x108)
/* XXX end common functions */
#define STALKER_TABLE_PTR                               (0x110)
#define SVC_STALKER_SYSCTL_NAME_PTR                     (0x118)
#define SVC_STALKER_SYSCTL_DESCR_PTR                    (0x120)
#define SVC_STALKER_SYSCTL_FMT_PTR                      (0x128)
#define SVC_STALKER_SYSCTL_MIB_PTR                      (0x130)
#define SVC_STALKER_SYSCTL_MIB_COUNT_PTR                (0x138)
#define HANDLE_SVC_HOOK                                 (0x140)
#define SVC_STALKER_CTL_CALLNUM                         (0x148)
#define RETURN_INTERCEPTOR                              (0x150)
#define IOS_VERSION                                     (0x158)
#define STALKER_LOCK                                    (0x160)
#define CUR_CALL_ID                                     (0x168)
