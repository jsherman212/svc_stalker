...
#define CURRENT_PROC                                    (0x98)
#define EXCEPTION_TRIAGE                                (0xa0)
/* next one only to be called inside common_functions.s */
#define COMMON_FXNS_GET_STALKER_CACHE                   (0xa8)
#define STALKER_CTL_FROM_TABLE                          (0xb0)
#define SHOULD_INTERCEPT_CALL                           (0xb8)
#define GET_NEXT_FREE_STALKER_CTL                       (0xc0)
#define GET_CALL_LIST_FREE_SLOT                         (0xc8)
#define GET_CALL_LIST_SLOT                              (0xd0)
#define IS_SYSCTL_REGISTERED                            (0xd8)
#define SEND_EXCEPTION_MSG                              (0xe0)
#define STALKER_TABLE_PTR                               (0xe8)
#define SVC_STALKER_SYSCTL_NAME_PTR                     (0xf0)
#define SVC_STALKER_SYSCTL_DESCR_PTR                    (0xf8)
#define SVC_STALKER_SYSCTL_FMT_PTR                      (0x100)
#define SVC_STALKER_SYSCTL_MIB_PTR                      (0x108)
#define SVC_STALKER_SYSCTL_MIB_COUNT_PTR                (0x110)
#define SVC_STALKER_CTL_CALLNUM                         (0x118)
#define SLEH_SYNCHRONOUS                                (0x120)
#define RETURN_INTERCEPTOR                              (0x128)
/* #define THREAD_SYSCALL_RETURN_LR                        (0x120) */
