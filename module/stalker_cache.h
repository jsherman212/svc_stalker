...
#define CURRENT_PROC                                    (0xa8)
#define EXCEPTION_TRIAGE                                (0xb0)
/* next one only to be called inside common_functions.s */
#define COMMON_FXNS_GET_STALKER_CACHE                   (0xb8)
#define STALKER_CTL_FROM_TABLE                          (0xc0)
#define SHOULD_INTERCEPT_CALL                           (0xc8)
#define GET_NEXT_FREE_STALKER_CTL                       (0xd0)
#define GET_CALL_LIST_FREE_SLOT                         (0xd8)
#define GET_CALL_LIST_SLOT                              (0xe0)
