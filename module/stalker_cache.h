...
#define SEND_EXCEPTION_MSG                              (0xa0)
#define STALKER_TABLE_PTR                               (0xa8)
#define SVC_STALKER_SYSCTL_NAME_PTR                     (0xb0)
#define SVC_STALKER_SYSCTL_DESCR_PTR                    (0xb8)
#define SVC_STALKER_SYSCTL_FMT_PTR                      (0xc0)
#define SVC_STALKER_SYSCTL_MIB_PTR                      (0xc8)
#define SVC_STALKER_SYSCTL_MIB_COUNT_PTR                (0xd0)
#define SVC_STALKER_CTL_CALLNUM                         (0xd8)
