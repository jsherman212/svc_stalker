...
WRITE_INSTR(0x2a0003e1); /* 0xfffffff0156b72ac    mov	w1, w0                    */ \
WRITE_INSTR(0xf940bbe0); /* 0xfffffff0156b72b0    ldr	x0, [sp, #0x170]          */ \
WRITE_INSTR(0x9400001c); /* 0xfffffff0156b72b4    bl	_stalker_ctl_from_table    */ \
WRITE_INSTR(0xf100001f); /* 0xfffffff0156b72b8    cmp	x0, #0x0                  */ \
WRITE_INSTR(0x54000240); /* 0xfffffff0156b72bc    b.eq	done                     */ \
WRITE_INSTR(0xf940b7f3); /* 0xfffffff0156b72c0    ldr	x19, [sp, #0x168]         */ \
WRITE_INSTR(0xf9404661); /* 0xfffffff0156b72c4    ldr	x1, [x19, #0x88]          */ \
WRITE_INSTR(0x94000028); /* 0xfffffff0156b72c8    bl	_should_intercept_syscall  */ \
WRITE_INSTR(0xf100001f); /* 0xfffffff0156b72cc    cmp	x0, #0x0                  */ \
WRITE_INSTR(0x540001a0); /* 0xfffffff0156b72d0    b.eq	done                     */ \
/*                                           send_exc_msg:                      */ \
WRITE_INSTR(0xd28000e0); /* 0xfffffff0156b72d4    mov	x0, #0x7                  */ \
WRITE_INSTR(0xd2800101); /* 0xfffffff0156b72d8    mov	x1, #0x8                  */ \
WRITE_INSTR(0xf940b7e2); /* 0xfffffff0156b72dc    ldr	x2, [sp, #0x168]          */ \
WRITE_INSTR(0xf9404442); /* 0xfffffff0156b72e0    ldr	x2, [x2, #0x88]           */ \
WRITE_INSTR(0xf100005f); /* 0xfffffff0156b72e4    cmp	x2, #0x0                  */ \
WRITE_INSTR(0x9a80b020); /* 0xfffffff0156b72e8    csel	x0, x1, x0, lt           */ \
WRITE_INSTR(0xf900b3e2); /* 0xfffffff0156b72ec    str	x2, [sp, #0x160]          */ \
...
WRITE_INSTR(0x54000160); /* 0xfffffff0156b732c    b.eq	not_found0               */ \
WRITE_INSTR(0x5280002a); /* 0xfffffff0156b7330    mov	w10, #0x1                 */ \
WRITE_INSTR(0x8b2a700b); /* 0xfffffff0156b7334    add	x11, x0, x10, uxtx #4     */ \
/*                                           search0:                           */ \
WRITE_INSTR(0xb940056c); /* 0xfffffff0156b7338    ldr	w12, [x11, #0x4]          */ \
WRITE_INSTR(0x6b01019f); /* 0xfffffff0156b733c    cmp	w12, w1                   */ \
WRITE_INSTR(0x54000100); /* 0xfffffff0156b7340    b.eq	found0                   */ \
WRITE_INSTR(0x1100054a); /* 0xfffffff0156b7344    add	w10, w10, #0x1            */ \
WRITE_INSTR(0x710ffd5f); /* 0xfffffff0156b7348    cmp	w10, #0x3ff               */ \
WRITE_INSTR(0x5400006a); /* 0xfffffff0156b734c    b.ge	not_found0               */ \
WRITE_INSTR(0x8b2a700b); /* 0xfffffff0156b7350    add	x11, x0, x10, uxtx #4     */ \
WRITE_INSTR(0x17fffff9); /* 0xfffffff0156b7354    b	search0                     */ \
/*                                           not_found0:                        */ \
WRITE_INSTR(0xd2800000); /* 0xfffffff0156b7358    mov	x0, #0x0                  */ \
WRITE_INSTR(0xd65f03c0); /* 0xfffffff0156b735c    ret                           */ \
/*                                           found0:                            */ \
WRITE_INSTR(0xaa0b03e0); /* 0xfffffff0156b7360    mov	x0, x11                   */ \
WRITE_INSTR(0xd65f03c0); /* 0xfffffff0156b7364    ret                           */ \
/*                                           _should_intercept_syscall:         */ \
WRITE_INSTR(0xf9400400); /* 0xfffffff0156b7368    ldr	x0, [x0, #0x8]            */ \
WRITE_INSTR(0xf100001f); /* 0xfffffff0156b736c    cmp	x0, #0x0                  */ \
WRITE_INSTR(0x54000160); /* 0xfffffff0156b7370    b.eq	do_not_intercept         */ \
WRITE_INSTR(0x52800009); /* 0xfffffff0156b7374    mov	w9, #0x0                  */ \
WRITE_INSTR(0xaa0003ea); /* 0xfffffff0156b7378    mov	x10, x0                   */ \
/*                                           search1:                           */ \
WRITE_INSTR(0xf940014b); /* 0xfffffff0156b737c    ldr	x11, [x10]                */ \
WRITE_INSTR(0xeb01017f); /* 0xfffffff0156b7380    cmp	x11, x1                   */ \
WRITE_INSTR(0x54000100); /* 0xfffffff0156b7384    b.eq	intercept                */ \
WRITE_INSTR(0x11000529); /* 0xfffffff0156b7388    add	w9, w9, #0x1              */ \
WRITE_INSTR(0x710fa13f); /* 0xfffffff0156b738c    cmp	w9, #0x3e8                */ \
WRITE_INSTR(0x5400006a); /* 0xfffffff0156b7390    b.ge	do_not_intercept         */ \
WRITE_INSTR(0x8b296c0a); /* 0xfffffff0156b7394    add	x10, x0, x9, uxtx #3      */ \
WRITE_INSTR(0x17fffff9); /* 0xfffffff0156b7398    b	search1                     */ \
/*                                           do_not_intercept:                  */ \
WRITE_INSTR(0xd2800000); /* 0xfffffff0156b739c    mov	x0, #0x0                  */ \
WRITE_INSTR(0xd65f03c0); /* 0xfffffff0156b73a0    ret                           */ \
/*                                           intercept:                         */ \
WRITE_INSTR(0xd2800020); /* 0xfffffff0156b73a4    mov	x0, #0x1                  */ \
WRITE_INSTR(0xd65f03c0); /* 0xfffffff0156b73a8    ret                           */ 
#endif
