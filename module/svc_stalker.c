...
/* these three functions are so stalker_main_patcher doesn't
...
static bool stalker_main_patcher(xnu_pf_patch_t *patch, void *cacheable_stream){
     ...
     *
     * We're using sleh_synchronous as an entry point for all this because
     * current_proc and exception_triage are nearby.
     *
     ...
     *  MOV Wn, 0xFFFFFFFF
     *
     * If we're in the right place, we should find...
     *  LDR Wn, [X19]
     *  CMP Wn, 0x15
     *  B.NE xxx
     *  LDRB Wn, [X19, n]
